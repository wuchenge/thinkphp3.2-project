...
<body>
    ...
    <div class="wrapper wrapper_marg">
        ...
        <div class="aegis_box">
            <div class="integral_cot">
                <div class="integral_left">
                    <a href="aegisdot.html">
                        <div class="integral_hd" style="background-image: url(/Public/home/images/integral_hd.jpg)"></div>
                    </a>
                </div>
                <div class="integral_center">
                    <ul>
                        <?php if(is_array($sylist)): $i = 0; $__LIST__ = $sylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <a href="<?php echo U('jifen/info',array('id'=>$vo['id']));?>">
                                <div class="integral_lis">
                                    <div class="integral_img">
                                        <img src="<?php echo ($vo["imgurl"]); ?>" alt="">
                                    </div>
                                    <div class="integral_wz">
                                        <h3><?php echo ($vo["gname"]); ?></h3>
                                        <!-- <h5>abs爱彼此 herman无限蓝牙防汗型</h5> -->
                                        <h4><span><?php echo ($vo["xyjifen"]); ?></span>分</h4>
                                    </div>
                                </div>
                            </a>
                ...
                <div class="integral_right">
                    <ul>
                        ...
                        <?php if(is_array($hotlist)): $i = 0; $__LIST__ = $hotlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <a href="<?php echo U('jifen/info',array('id'=>$vo['id']));?>">
                                <div class="integralR_lis">
                                    <img src="<?php echo ($vo["imgurl"]); ?>" alt="">
                                    <div class="integralR_wz">
                                        <h5><?php echo ($vo["gname"]); ?></h5>
                                        <h6><span><?php echo ($vo["xyjifen"]); ?></span>分</h6>
                                    </div>
                                </div>
                            </a>
                        </li><?php endforeach; endif; else: echo "" ;endif; ?>
