...
//生成积分明细
function add_pointmx($uid, $xiangmu,$money){
    $point = M("user")->find($uid);
    $pointi['uid']=$uid;
    $pointi['xiangmu']=$xiangmu;
    $pointi['money']=$money;
    $pointi['yuemoney']=$point['integral'];
    $pointi['addtime']=time();
...
//生成财务明细
function add_moneymx($uid, $xiangmu,$money){
    $point = M("user")->find($uid);
    $pointi['uid']=$uid;
    $pointi['xiangmu']=$xiangmu;
    $pointi['money']=$money;
    $pointi['yuemoney']=$point['balance'];
    $pointi['addtime']=time();
    $result = M("moneymx")->add($pointi);
    return $result;
}
