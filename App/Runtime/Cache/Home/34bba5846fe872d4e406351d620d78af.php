                ...
                <div class="aegisN_lcot">
                    <div class="aegisN_left">
                            ...
                            <div class="container">
                                <div class="aegisND_close"><img src="/Public/home/images/close.svg" alt=""></div>
                                    ...
                                    <div class="aegisND_cot">
                                        <?php if(is_array($cate)): $k = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "敬请期待" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="aegisND_lis">
                                                <div class="aegisNDL_cot">
                                                    <ul>
                                                        <?php if(is_array($vo["sxjihe"])): $i = 0; $__LIST__ = $vo["sxjihe"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?><li>
                                                                <a href="<?php echo U('gift/index',array('tcate'=>$v2['id']));?>">
                                                                <label>
                                                                    <input  name="lz">
                                                                    <i></i>
                                                            ...
                                                            </li><?php endforeach; endif; else: echo "敬请期待" ;endif; ?>
                                                    </ul>
                                                </div>
                                            </div><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                        ...
                        <div class="aegisN_right">
                            <form id="topic_search" method="get" action="<?php echo U('gift/index');?>" onkeydown="if(event.keyCode==13)return topicsearch()">
                                <div class="aegisN_search">
                                    <i class="fa fa-search"></i><input type="text" name="title" value="<?php echo ($_GET['title']); ?>" placeholder="搜索产品">
                                </div>
                            </form>
                            <div class="aegisN_jx">
                                <i class="sort_desc"></i>
                ...
                <div class="container">
                    <div class="aegisS_cot">
                        <div class="aegisS_left">
                            <?php if(($count == 0)): ?>敬请期待...
                                <?php else: ?>
                                <p>当前产品数 <span>1-12</span> 总计<?php echo ($count); ?>件</p><?php endif; ?>
                        </div>
