...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 财法管理 <span class="c-gray en">&gt;</span> 财法添加 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<article class="page-container">
	<form class="form form-horizontal" name="form1" id="form-news-add" enctype='multipart/form-data' method="post" action="<?php echo U('caifa/add');?>" >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>财法标题：</label>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width: 30%;">
				<input type="number" class="input-text" min="0"  value="" id="ordernum" name="yprice" width="200px">
			</div>
		</div>
		<div class="row cl">
