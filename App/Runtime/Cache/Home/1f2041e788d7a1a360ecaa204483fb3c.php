                    ...
                    <div class="aegisN_lcot">
                                            ...
                                            <div class="aegisNDL_cot">
                                                <ul>
                                                     <?php if(is_array($vo["sxjihe"])): $i = 0; $__LIST__ = $vo["sxjihe"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?><li>
                                                            <a href="<?php echo U('mall/index',array('tcate'=>$v2['id']));?>">
                                                                <label>
                                                                    <input  name="lz">
                                                                    <i></i>
                        ...
                        <div class="aegisN_right">
                            <div class="aegisN_search">
                                <form id="topic_search" method="get" action="<?php echo U('mall/index');?>" onkeydown="if(event.keyCode==13)return topicsearch()">
                                <i class="fa fa-search"></i><input value="<?php echo ($_GET['title']); ?>" name="title"  type="text" placeholder="搜索产品">
                            </form>
                            </div>
                            <div class="aegisN_jx">
                                <i class="sort_desc"></i>
