...
<body>
  ...
  <div class="wrapper wrapper_marg">
    <div class="main_ban">
      <img src="/Public/home/images/news.jpg" alt="">
      <div class="mainB_wz">
        <h3>新闻中心</h3>
        <h5>news</h5>
      </div>
    ...
    <div class="news_box" style="background-image: url(/Public/home/images/news_bg.jpg)">
      <div class="container">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
              <a href="<?php echo U('news/info',array('id'=>$vo['id']));?>" target="_blank">
                <div class="news_lis">
                  <div class="news_img">
                  ...
                  <div class="news_wz">
                    ...
                    <h5><?php echo (date("Y年m月d日",$vo["addtime"])); ?> | <span>资讯</span></h5>
