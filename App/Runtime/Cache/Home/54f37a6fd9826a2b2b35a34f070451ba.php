...
<body>
  ...
  <div class="wrapper wrapper_marg">
    ...
    <div class="aegis_box" style="background-image: url(/Public/home/images/plot_bg.jpg)">
                  ...
                  <div class="aegisND_cot">
                    <?php if(is_array($cate)): $k = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="aegisND_lis">
                      <div class="aegisNDL_cot">
                        <ul>
                        <?php if(is_array($vo["sumsx"])): $i = 0; $__LIST__ = $vo["sumsx"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?><li>
                            <?php if($k == 1): ?><a href="<?php echo U('space/index',array('c1id'=>$v2['id']));?>">
                              <?php elseif($k == 2): ?>
                                   <a href="<?php echo U('space/index',array('c2id'=>$v2['id']));?>">
                              <?php else: ?>
                                  <a href="<?php echo U('space/index',array('c3id'=>$v2['id']));?>"><?php endif; ?>
                              <label>
                                <input  name="lz">
                                <i></i>
      ...
      <div class="aegis_cot">
        <div class="row">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-4">
            <a href="<?php echo U('space/info',array('id'=>$vo['id']));?>">
              <div class="space_lis">
                <div class="space_img" style="background: url(<?php echo ($vo["imgurl"]); ?>)  center /cover;">
                  <img src="/Public/home/spacebg.png" alt="">
                </div>
                <div class="space_wz">
                  <h3><span><?php echo ($vo["title"]); ?></span><i><?php echo ($vo["price"]); ?>元/月</i></h3>
                  <p><?php echo ($vo["keywords"]); ?></p>
                  <h5><span style="background: #f4f7f9;color: #849aae"><?php echo ($vo["c1name"]); ?></span><span style="background: #ffece8; color: #ff8062;"><?php echo ($vo["c2name"]); ?></span><span
                     style="background: #e1f5ed; color: #33be85;"><?php echo ($vo["c3name"]); ?></span></h5>
                </div>
              </div>
            </a>
          </div><?php endforeach; endif; else: echo "" ;endif; ?>
